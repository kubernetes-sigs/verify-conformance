...
replace (
	...
	sigs.k8s.io/json/internal/golang/encoding/json => sigs.k8s.io/json/internal/golang/encoding/json v0.0.0-20250730193827-2d320260d730
)
...
require (
	...
	sigs.k8s.io/prow v0.0.0-20251205154457-476eedbb024e
...
require (
	...
	github.com/tektoncd/pipeline v1.11.0 // indirect
